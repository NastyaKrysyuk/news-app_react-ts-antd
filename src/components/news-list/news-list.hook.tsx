...
const useNewsList = ({ pageSize }: { pageSize: number }) => {
  ...
  const getNews = async () => {
    setLoading(true)
    try {
      await Newsapi.getNews('?q=art%painter&NFT&sortBy=popularity&apiKey=e1f6d61fb3224655b09882e1f3fc11b4').then((res: any) => {
