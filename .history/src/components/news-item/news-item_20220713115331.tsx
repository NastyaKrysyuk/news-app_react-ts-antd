    ...
    <>
      {
        values.map((article: TNewsItem, index: number) => (
          ...
          <div key ={new Date().toISOString()} className="site-card-wrapper" style={{ backgroundImage: `url(${article.urlToImage})`, cursor: 'pointer' }} onClick={(e: any) => {
